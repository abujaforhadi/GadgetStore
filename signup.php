...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
		...
		$query = "INSERT INTO `users`(`user_id`, `user_name`, `email`, `password`, `number`, `address`) values ('$user_id','$user_name','$email','$password','$number','$address')";
...
<header id="header">
	...
	<div id="box">
		...
		<form method="post">
			...
			<input id="text" type="number" name="number" placeholder="Phone number"><br><br>
